...
def search_widget(doctype, txt, query=None, searchfield=None, start=0,
	...
	if query and query.split()[0].lower()!="select":
		...
		if doctype == 'Customer' and frappe.local.site in ["ifmi.digitalasiasolusindo.com","bjm.digitalasiasolusindo.com","honda2.digitalasiasolusindo.com","newbjm.digitalasiasolusindo.com"]:
