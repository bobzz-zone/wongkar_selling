...
doc_events = {
	...
	"Journal Entry":{
		...
		"on_cancel": ["wongkar_selling.wongkar_selling.sync_custom.cencel_sumber_asli","wongkar_selling.custom_standard.custom_journal_entry.cek_cancel_adv_leasing","wongkar_selling.custom_standard.custom_stock_entry.cek_diskon_pinv",
                'wongkar_selling.custom_standard.custom_journal_entry.hitung_outstanding_claim',"wongkar_selling.custom_standard.custom_journal_entry.diskon_pinv"],
