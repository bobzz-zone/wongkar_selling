...
def get_data(filters):
	...
	data = frappe.db.sql(""" SELECT 
			...
			l.`outstanding_sipm` as outstanding_amount,
			...
			WHERE sipm.docstatus = 1 AND sipm.cara_bayar = "Credit" AND tl.name IS not NULL and tl.docstatus =1
			AND sipm.posting_date <= '{}' and l.`outstanding_sipm` > 0
			{}
